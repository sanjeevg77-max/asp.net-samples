...
namespace WebApp6UnitTestsandIdentity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> SendCode(string returnUrl, bool rememberMe)
        {
            ...
            var userFactors = await UserManager.GetValidTwoFactorProvidersAsync(twoFactorUser);
        ...
        public async Task<ActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            var token = await UserManager.GenerateTwoFactorTokenAsync(twoFactorUser, model.SelectedProvider);
